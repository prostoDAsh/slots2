...
{
    public sealed class WheelModel1
    {
        ...
        private FinalScreenData1 finalScreenData;
        ...
        public WheelModel1() //конструктор класса, + устанавливает начальное состояние
        {
        ...
        {
            private readonly WheelModel1 _model;
            
            public NotRunningWheel(WheelModel1 model) => _model = model;
        ...
        private sealed class StartingWheel : IWheelState
        {
            ...
            public StartingWheel(WheelModel1 model) => _model = model;
        ...
        {
            private readonly WheelModel1 _model;
            public RunningWheel(WheelModel1 model) => _model = model;
        ...
        private sealed class StoppingWheel : IWheelState
        {
            ...
            public StoppingWheel(WheelModel1 model) => _model = model;
