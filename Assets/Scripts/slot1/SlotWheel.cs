...
namespace DefaultNamespace
{
    public class SlotWheel : MonoBehaviour
    {
        ...
        private Slot1MachineController slot1MachineController;
        ...
        private void Awake()
        {
            slot1MachineController = GetComponentInParent<Slot1MachineController>();
        ...
        public void ScaleWin()
        {
            ...
            {
                slot1MachineController.UpdateScoreText();
                slot1MachineController.PlayMoneySource();
                if(!slot1MachineController.isFreeSpinsRunning) return;
                slot1MachineController.UpdateFsScoreText();
            });
        }
        ...
        private void StopAnimation()
        {
            ...
            {
                slot1MachineController.PlayForceMoneySource();
            }
            for (int i = 0; i < symbols.Count; i++) 
            {
            ...
            slot1MachineController.UpdateScoreTextImmediately();
